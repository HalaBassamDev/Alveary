...
class Payment2 extends StatefulWidget {
  final String codeId;
  final String email;
  const Payment2({super.key, required this.codeId, required this.email});

  @override
  State<Payment2> createState() => _Payments2();
}

class _Payments2 extends State<Payment2> {
          ...
          child: Column(
              ...
              children: [
                ...
                Container(
                    ...
                    child: const Center(
                        child: Text("Total Amount /yearly : \$1500",
                            style: TextStyle(
                              fontFamily: "Open2",
                              fontSize: 19,
                ...
                Form(
                  ...
                  child: SingleChildScrollView(
                    ...
                    Container(
                        ...
                        height: 53,
                        margin:
                            const EdgeInsets.only(top: 29, left: 35, right: 30),
                        child: MaterialButton(
                          minWidth: 380,
                          height: 53,
