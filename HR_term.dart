...
import 'package:splash_screen/profile/hr_privacyPolicy.dart';
import 'package:splash_screen/profile/privacy.dart';
import 'package:splash_screen/widget.dart';

class TermServices_hr extends StatelessWidget {
  const TermServices_hr({Key? key}) : super(key: key);
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const PrivacyPolicy_hr()));
                    },
