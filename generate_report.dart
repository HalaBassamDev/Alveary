...
Widget showAttendanceReport() {
  if (variable.attendance != null && variable.attendance.isNotEmpty) {
    return ListView.builder(
      itemCount: variable.attendance.length,
      itemBuilder: (context, index) {
        final attendance = variable.attendance[index];
...
Widget showDedection(index) {
  ...
  if (difference != null) if (hours == 8 && minutes == 0) {
    ...
    String overTimeString = variable.attendance[index]['overTime'] ?? '';
    return const Text(
      'Over time: min',
      textAlign: TextAlign.center,
      style: TextStyle(
    ...
    print(variable.attendance[index]['overTime']);
    return const Text(
      'Late: min',
      textAlign: TextAlign.center,
      style: TextStyle(
